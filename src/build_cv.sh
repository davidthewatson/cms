...
while inotifywait -r -e close_write -e move -e create -e delete $SRCDW $SRCWW $STATIC
do
#    rm -rf $DOCS/*
    cp -rf $STATIC/* $DOCS/.
    echo "$STATIC/* $DOCS/."
    ...
    wkhtmltopdf -T 2cm -L 2cm -R 2.5cm http://localhost:8000/cv/dw/index.html $DOCS/cv/dw/index.pdf
